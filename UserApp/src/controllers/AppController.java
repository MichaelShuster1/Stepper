...
public class AppController {
    ...
    private void displayChat(){
        chatComponent.maxHeightProperty().bind(Bindings.multiply(primaryStage.heightProperty(), 0.25));
        chatComponent.maxWidthProperty().bind(Bindings.multiply(primaryStage.widthProperty(), 0.35));
